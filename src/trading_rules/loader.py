...
def get_engine_config() -> EngineConfig:
    ...
    ex = ExitThresholds(
        time_stop_max_days=_i("TRADING_TIME_STOP_DAYS", 15),
        time_stop_min_pnl_pct=_f("TRADING_TIME_STOP_MIN_PNL", 0.01),
...
def get_rulebook() -> Rulebook:
    ...
    sell = SellRuleParams(
        ...
        time_stop_days=_i("TRADING_TIME_STOP_DAYS", 15),
        time_stop_min_pnl=_f("TRADING_TIME_STOP_MIN_PNL", 0.01),
        time_stop_early_days=_i("TRADING_TIME_STOP_EARLY_DAYS", 5),
        time_stop_early_loss_pct=_f("TRADING_TIME_STOP_EARLY_LOSS_PCT", 0.05),
        time_stop_hash_spread=_i("TRADING_TIME_STOP_HASH_SPREAD", 4),
